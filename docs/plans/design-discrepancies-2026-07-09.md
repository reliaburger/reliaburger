...
| D20 | P2 | Document drift | The self-upgrade design describes reporting-tree directives, gossip version discovery, leadership transfer, and reverse-order rollback. The implementation deliberately uses authenticated HTTP, version polling, leader-last in-place upgrade, and leader-last rollback. | [Bun design §5.5](../design/agent-bun.md#55-self-upgrade-sequence); [upgrade plan](self-upgrade-plan-2026-07.md); src/upgrade/; docs/progress.md:409-424 |
