...
- [ ] **C14** (P1) Renew and hot-reload every served certificate class.
  ...
  - [ ] Wire the live handle into Bun's API/registry, Raft/reporting clients and servers, internal HTTPS clients and diagnostics.
  - [ ] Add authenticated node CSR renewal with Raft serial allocation, issuer lifetime bounds and safe retry through leader changes; qualify it on a real cluster.
