...
- [ ] **C14** (P1) Renew and hot-reload every served certificate class.
  ...
  - [ ] Start automatic renewal at the signed lifetime midpoint, persist and publish responses, report worker health and retry safely through leader changes; qualify it on a real cluster.
